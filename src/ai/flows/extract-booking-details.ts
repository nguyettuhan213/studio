...
const ExtractBookingDetailsOutputSchema = z.object({
  ...
  target_email: z.string().email().describe('Recipient email for request confirmation or processing.'),
  cc_email: z.string().email().optional().describe('Optional CC email address for the booking confirmation.'),
