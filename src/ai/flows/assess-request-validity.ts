...
const AssessRequestValidityInputSchema = z.object({
  ...
  target_email: z.string().email().describe('The target email for the booking.'),
  cc_email: z.string().email().optional().describe('The CC email for the booking, if any.'),
  requestorMail: z.string().email().describe('The email of the person making the request.'),
